...
class _MoviesPageState extends State<MoviesPage> {
  ...
  final Map<String, List<String>> _moviesByCategory = {
    'Resume To Watch': ['Movie 1', 'Movie 2'],
    'All': ['Movie 3', 'Movie 4', 'Movie 5', 'Movie 6'],
    'Favourite': ['Movie 7', 'Movie 8'],
    'Demo VOD': ['Movie 9']
  };
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4.h),
                  for (int i = 0; i < _movieCategories.length; i++) ...[
                    InkWell(
                      onTap: () {
                        setState(() {
                          _selectedRowIndex = i;
                      ...
                      child: RowWidget(
                        text1: _movieCategories[i],
                        text2: _moviesByCategory[_movieCategories[i]]
                                ?.length
                                .toString() ??
                            '0',
              ...
              children: [
                ...
                Expanded(
                  child: GridView.builder(
                    ...
                    itemCount:
                        _moviesByCategory[_movieCategories[_selectedRowIndex]]
                                ?.length ??
                            0,
                    itemBuilder: (context, index) {
                      String movie = _moviesByCategory[
                          _movieCategories[_selectedRowIndex]]![index];
                      return InkWell(
                        highlightColor: Colors.transparent,
                        splashColor: Colors.transparent,
                        onTap: () {
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              SizedBox(
                                  height: 8.0), // Add some space at the top
                              Icon(
